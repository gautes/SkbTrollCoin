 ...
 * between trollcoind, and trollcoin-qt and non-server tools.
*/
...
void Shutdown()
{
    ...
    RenameThread("trollcoin-shutoff");
...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/trollcoin/trollcoin>";
    const std::string URL_WEBSITE = "<https://trollcoincore.org>";
...
void ThreadImport(std::vector<boost::filesystem::path> vImportFiles)
{
    ...
    RenameThread("trollcoin-loadblk");
...
/** Sanity checks
 *  Ensure that Trollcoin is running in a usable environment with all

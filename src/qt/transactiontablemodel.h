...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, TrollcoinUnits::SeparatorStyle separators=TrollcoinUnits::separatorStandard) const;

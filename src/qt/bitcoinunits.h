...
/** Trollcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class TrollcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit TrollcoinUnits(QObject *parent);

    /** Trollcoin units.
      @note Source: https://en.trollcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef TrollcoinUnits::Unit TrollcoinUnit;

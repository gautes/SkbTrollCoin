...
# TestNode: A peer we use to send messages to trollcoind, and store responses.
...
class CompactBlocksTest(TrollcoinTestFramework):
    def __init__(self):
        super().__init__()
    ...
    # This test actually causes trollcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that trollcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for trollcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # trollcoind will not send blocktxn responses for blocks whose height is

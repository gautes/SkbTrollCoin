Trollcoin Core version 0.13.2 is now available from:

  <https://trollcoin.org/bin/trollcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update trollcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow trollcoin-tx to create v2 transactions (btcdrak)

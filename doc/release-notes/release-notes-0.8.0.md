Trollcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/trollcoin/files/Trollcoin/trollcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Trollcoin
...
New/changed settings (command-line or trollcoin.conf file)
--------------------------------------------------------

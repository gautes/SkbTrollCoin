Trollcoin Core version 0.10.4 is now available from:

  <https://trollcoin.org/bin/trollcoin-core-0.10.4/>
...
- #6953 `43c2789` Split trollcoin-tx into its own package
- #6953 `dfe0d4d` Include trollcoin-tx binary on Debian/Ubuntu

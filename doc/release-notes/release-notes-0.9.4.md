Trollcoin Core version 0.9.4 is now available from:

  https://trollcoin.org/bin/0.9.4/
...
this update is incompatible with the Trollcoin system and could lead to consensus
forks.

Trollcoin Core released binaries from https://trollcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~trollcoin/+archive/ubuntu/trollcoin
- A third-party or self-compiled Trollcoin Core

upgrade to Trollcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
